...
While there are no exercises for this section, hopefully this chapter has provided significant insight when developing quality code, debugging it and profiling. While this section could go in much further depth, have some idea what to look into allows one to explore the tooling and have an idea on certain behaviour that can be observed.


* You should know and understand
  * Different test types and their purpose
  * Using xunit and writing unit tests
  * Purpose of comparing data with actual and expected
  * Writing documentation and using CS documentation XML
